---
title: Welcome to My DevOps & Cloud Journey
description: Practical guides and tutorials on DevOps, MLOps, Containers, and CI/CD from a 4th-year Software Engineering student with roots in Zambia and based in Kenya.
---

# 🇿🇲🇰🇪 Building in the Cloud: My Systems Engineering Journey

Hello! I’m Josiah, a **4th-year Software Engineering student** currently based in Kenya, though my journey started in **Zambia**. I'm also the **Cloud & DevOps Lead for GDSC** on my campus.
...
Ready to dive into the world of infrastructure-as-code and automated pipelines? Let's get started!
